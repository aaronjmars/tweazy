        ...
        <CardContent className="space-y-4">
            ...
            <>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="font-medium text-foreground">Payment Required</h3>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {paymentDetails.description ||
                        "Payment required to continue with your request"}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-muted/50 border rounded-lg p-4 space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-foreground">
                      {paymentContext.walletType === "metamask"
              ...
              <div className="flex space-x-3 pt-4">
                ...
                <Button
                  ...
                  disabled={
                    state.isProcessing || (!address && paymentContext.walletType === "metamask")
                  }
                  className="flex-1"
                >
                  <Wallet className="w-4 h-4 mr-2" />
                  Pay with{" "}
                  {paymentContext.walletType === "metamask" ? "Non-custodial Wallet" : "CDP Wallet"}
                </Button>
              </div>
            </>
          )}
          ...
          {step === "processing" && (
            <div className="text-center space-y-4 py-6">
              ...
              <div>
                <h3 className="font-medium text-foreground">Processing Payment</h3>
          ...
          {step === "success" && (
            <div className="text-center space-y-4 py-6">
              ...
              <div>
                <h3 className="font-medium text-foreground">Payment Successful!</h3>
                <p className="text-sm text-muted-foreground mt-1">
